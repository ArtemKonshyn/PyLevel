...
<h2 id="установка-celery-и-брокера">Установка Celery и брокера</h2>
...
Варианты запуска<br>
1.<a href="https://habr.com/ru/post/490040/">Docker</a><br>
2. <a href="https://www.codedisciples.in/celery-windows.html">WSL</a><br>
3. <a href="https://www.distributedpython.com/2018/08/21/celery-4-windows/">Переменная окружения</a> или <a href="https://github.com/celery/celery/issues/4081#issuecomment-408581158">прямо в коде</a></p>
...
<p><code>-A app_name</code>  - указать имя приложения,  <code>worker</code>  - запустить один воркер, лог левел, уровень подробностей</p>
